...
class _TroullierGenerator(object):
    ...
    def _build_lmatrix(self):
        ...
        m = np.zeros((4,4))
        c = self.c
        m[0,:] = np.array([ 1., c**2,  c**6,    c**7]) # p
        m[1,:] = np.array([ 0., 2*c, 6*c**5,  7*c**6]) # p'
        m[2,:] = np.array([ 0., 2., 30*c**4, 42*c**5]) # p''
        m[3,:] = np.array([ 0., 0.,120*c**3,210*c**4]) # p'''
        return m
    ...
    def _solve_cont(self,a4):
        ...
        a0,a2,a6,a7 = np.linalg.solve(lmatrix,rvec)
        return a0,a2,a6,a7
    ...
    def _make_p(self,as_):
        ...
        """
        a0,a2,a4,a6,a7 = as_
        return Polynomial((a0,0.,a2,0.,a4,0.,a6,a7))
    ...
    def _get_norm_diff(self,a4):
        ...
        """
        a0,a2,a6,a7 = self._solve_cont(a4)
        as_ = (a0,a2,a4,a6,a7)
    ...
    def _solve_bracketed(self,a4l,a4h):
        ...
        a0,a2,a6,a7 = self._solve_cont(a4)
        return (a0,a2,a4,a6,a7)

    def _solve(self):
        """ 
        Return the coefficients for the PP.

        Returns (a0,a2,a4,a6,a7)
        """
